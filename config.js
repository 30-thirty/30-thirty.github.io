...
let weaponlists = {
    ...
    <option value="Riftcarver's Implement">Riftcarver's Implement</option>
    ...
    <option value="Mallet of the Awakening">Mallet of the Awakening</option>
    ...
    <option value="Thunderfall, Stormhammer of the Chief Thane">Thunderfall, Stormhammer of the Chief Thane</option>
...
function updateStats()
{
    ...
    let beltenchant = document.querySelector("#beltenchant").value
    ...
    let ringoneenchant = document.querySelector("#ringoneenchant").value
    let ringtwoenchant = document.querySelector("#ringtwoenchant").value
    let neckenchant = document.querySelector("#neckenchant").value



    // Talents
    let deflection = Number(document.getElementById("deflection").value);
    let impSS = Number(document.getElementById("impSS").value);
    ...
    let gear = [
        ...
        enchants[beltenchant],
        enchants[legenchant],
        enchants[feetenchant],
        enchants[mhwepenchant],
        enchants[ohwepenchant],
        enchants[ringoneenchant],
        enchants[ringtwoenchant],
        enchants[neckenchant]
    ];
    ...
    attackpower += mhstone == "Consecrated" ? 108 : 0;
    ...
    if (_dualWield) {
        ...
        attackpower += ohstone == "Consecrated" ? 108 : 0;
    ...
    stamina += foodbuff == "Hardened Mushroom" ? 25 : 0;
    haste *= foodbuff == "Danonzo's Tel'Abim Delight" ? 2 : 1
    ...
    let globals = {
        tankStats: {
            ...
            damageMod: stance == "Defensive Stance" ? 0.9 : 1.0,
            ...
            talents: {
                ...
                concblow: document.getElementById("concblow").checked,
        ...
        bossStats: {
            ...
            MHWepSkill: 315,
            damageMod: (stance == "Defensive Stance" ? 0.9 : 1.0)*(stance == "Berserker Stance" ? 1.1 : 1.0),
        ...
        config: {
            ...
            shart: document.querySelector("#shart").checked,
            ...
            shartdelay: Number(document.querySelector("#shartdelay").value)*1000,
        },
    }
    return globals;
}