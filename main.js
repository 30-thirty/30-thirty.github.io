...
function saveInput()
{
    ...
    localStorage.setItem("neckenchant", document.querySelector("#neckenchant").selectedIndex)
    ...
    localStorage.setItem("beltenchant",document.querySelector("#beltenchant").selectedIndex)
    ...
    localStorage.setItem("ringoneenchant", document.querySelector("#ringoneenchant").selectedIndex)
    localStorage.setItem("ringtwoenchant", document.querySelector("#ringtwoenchant").selectedIndex)
    ...
    localStorage.setItem("concblow",document.getElementById("concblow").checked);
    ...
    localStorage.setItem("fourPieceHeroism", document.querySelector("#fourPieceHeroism").checked)
    ...
    localStorage.setItem("scrollprot4", document.getElementById("scrollprot4").checked);
    ...
    localStorage.setItem("shart", document.querySelector("#shart").checked)
    ...
    localStorage.setItem("shartdelay", document.querySelector("#shartdelay").value)
...
{
    // Tank Settings
    document.querySelector("#race").selectedIndex = localStorage.getItem("race") ? localStorage.getItem("race") : 8;
    document.querySelector("#head").selectedIndex = localStorage.getItem("head") ? localStorage.getItem("head") : 17;
    document.querySelector("#neck").selectedIndex = localStorage.getItem("neck") ? localStorage.getItem("neck") : 20;
    document.querySelector("#shoulder").selectedIndex = localStorage.getItem("shoulder") ? localStorage.getItem("shoulder") : 19;
    document.querySelector("#cape").selectedIndex = localStorage.getItem("cape") ? localStorage.getItem("cape") : 18;
    document.querySelector("#chest").selectedIndex = localStorage.getItem("chest") ? localStorage.getItem("chest") : 14;
    document.querySelector("#wrist").selectedIndex = localStorage.getItem("wrist") ? localStorage.getItem("wrist") : 18;
    document.querySelector("#hands").selectedIndex = localStorage.getItem("hands") ? localStorage.getItem("hands") : 20;
    document.querySelector("#waist").selectedIndex = localStorage.getItem("waist") ? localStorage.getItem("waist") : 14;
    document.querySelector("#legs").selectedIndex = localStorage.getItem("legs") ? localStorage.getItem("legs") : 16;
    ...
    document.querySelector("#trinketone").selectedIndex = localStorage.getItem("trinketone") ? localStorage.getItem("trinketone") : 10;
    document.querySelector("#trinkettwo").selectedIndex = localStorage.getItem("trinkettwo") ? localStorage.getItem("trinkettwo") : 11;
    ...
    document.querySelector("#ohwepenchant").selectedIndex = localStorage.getItem("ohwepenchant") ? localStorage.getItem("ohwepenchant") : 2;
    ...
    document.getElementById("concblow").checked = localStorage.getItem("concblow") == "true" ? true : false;
    ...
    document.querySelector("#fourPieceHeroism").checked = localStorage.getItem("fourPieceHeroism") == "true" ? true : false;
    ...
    // Buffs
    document.getElementById("mhstone").selectedIndex = localStorage.getItem("mhstone") ? localStorage.getItem("mhstone") : 1;
    ...
    document.querySelector("#shart").checked = localStorage.getItem("shart") == "true" ? true : false;
    document.querySelector("#ieadelay").value = localStorage.getItem("shartdelay") ? localStorage.getItem("shartdelay") : 10;
